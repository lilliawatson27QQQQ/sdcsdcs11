...
function InstantTransferTab({ balance, onTransfer }: InstantTransferTabProps) {
  ...
  // Step 1: Form
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-900 p-4 pb-24">
      <div className="max-w-lg mx-auto space-y-6">
        ...
        {/* Balance Card */}
        <Card className="bg-gradient-to-br from-emerald-500/20 via-cyan-500/20 to-blue-600/20 backdrop-blur-md shadow-2xl border border-emerald-400/30 text-white relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-r from-emerald-400/5 via-cyan-400/5 to-blue-400/5 animate-pulse"></div>
          <CardContent className="p-8 text-center relative z-10">
            <div className="flex items-center justify-center gap-3 mb-4">
              <div className="w-12 h-12 bg-gradient-to-r from-emerald-500 to-cyan-600 rounded-2xl flex items-center justify-center shadow-lg">
        ...
        <Card className="bg-gradient-to-br from-green-500/20 via-emerald-500/20 to-teal-600/20 backdrop-blur-md shadow-2xl border border-green-400/30 text-white relative overflow-hidden">
          ...
          <CardHeader className="relative z-10">
            <CardTitle className="text-white text-2xl flex items-center justify-center gap-3">
              ...
              <div className="text-center">
                <h3 className="text-xl font-bold">بيانات التحويل</h3>
