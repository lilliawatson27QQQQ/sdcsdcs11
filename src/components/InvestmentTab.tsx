  ...
  return (
    <div className="space-y-6 sm:space-y-8 pb-20 bg-transparent px-2 sm:px-0 max-w-6xl mx-auto">
      ...
      <div className="text-center mb-8">
        <div className="inline-flex items-center justify-center p-4 bg-gradient-to-br from-purple-500/20 to-pink-600/20 rounded-full backdrop-blur-sm mb-6">
          <BarChart3 className="w-12 h-12 text-purple-400" />
        </div>
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 bg-gradient-to-r from-white via-purple-100 to-white bg-clip-text text-transparent">
        ...
        <div className="flex items-center justify-center space-x-6 space-x-reverse mt-6">
          <div className="flex items-center space-x-2 space-x-reverse text-green-400">
            ...
            <span className="text-sm font-medium">استثمار آمن</span>
          </div>
          <div className="flex items-center space-x-2 space-x-reverse text-blue-400">
            <TrendingUp className="w-5 h-5" />
            <span className="text-sm font-medium">عوائد مضمونة</span>
          </div>
          <div className="flex items-center space-x-2 space-x-reverse text-purple-400">
            <Clock className="w-5 h-5" />
            <span className="text-sm font-medium">سحب سريع</span>
          </div>
        </div>
      </div>

      {/* Investment Performance Overview - Simplified */}
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-3 space-x-reverse">
              ...
              <div>
                <h3 className="text-xl font-bold text-white">أداء المحفظة</h3>
                <p className="text-indigo-300 text-sm">ملخص استثماراتك</p>
              </div>
            </div>
            <div className="text-right">
              <p className="text-indigo-300 text-sm">معدل العائد</p>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="bg-purple-500/10 rounded-lg p-4 text-center border border-purple-400/20">
              ...
              <p className="text-purple-300 text-xs">القيمة الإجمالية</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {investmentOptions.map((option) => (
            <Card
              key={option.id}
              className={`bg-gradient-to-br ${option.color}/20 backdrop-blur-md border border-white/30 hover:bg-white/15 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-105`}
            >
              <CardContent className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3 space-x-reverse">
