      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center p-4 bg-gradient-to-br from-indigo-500/20 to-purple-600/20 rounded-full backdrop-blur-sm mb-6">
              ...
              {loginMethod === "google" ? (
                <div className="space-y-4">
                  <Button
                    ...
                    className="w-full h-12 bg-white hover:bg-gray-50 text-gray-900 font-medium flex items-center justify-center gap-3 transition-all duration-200 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed rounded-lg"
